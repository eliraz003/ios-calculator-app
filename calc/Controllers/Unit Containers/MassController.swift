...
var massUnits: UnitContainer = UnitContainer({ add, reference in
    ...
    add([.ShowInResultRendering, .NewGroup], Mass(name: Mass.USTon, symbol: "US-Ton", rate: 9.07200000))
    add([.ShowInResultRendering], Mass(name: Mass.ImperialTon, symbol: "Imp-Ton", rate: 1016000000))
    
    add([.ShowInResultRendering, .NewGroup], Mass(name: Mass.Stone, symbol: "St", rate: 6350000))
